 ...
 * 能够在父组件内完整的显示视频，并保持视频本身的比例
 */
public class XibaResizeTextureView extends TextureView {

    public static final String TAG = XibaResizeTextureView.class.getSimpleName();

    protected Point mVideoSize;

    public XibaResizeTextureView(Context context) {
        super(context);
        init();
    }

    public XibaResizeTextureView(Context context, AttributeSet attrs) {
        super(context, attrs);
        init();
    }
