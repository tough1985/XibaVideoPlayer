...
public class XibaListPlayUtil {
    ...
    protected int mPlayingPosition = -1;  //当前正在播放的item索引
...
//                    playingItemPositionChangeImpl.prePlayingItemPositionChange(utilMsg);
    ...
    protected void startPlay(String url, int position, ViewGroup itemContainer, XibaVideoPlayerEventCallback eventCallback, int lastState){
