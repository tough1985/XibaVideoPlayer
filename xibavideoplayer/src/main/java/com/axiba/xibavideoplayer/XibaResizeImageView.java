...
/**
 * Created by xiba on 2016/12/10.
 */

public class XibaResizeImageView extends ImageView {

    public static final String TAG = XibaResizeImageView.class.getSimpleName();

    protected Point mVideoSize;

    public XibaResizeImageView(Context context) {
        super(context);
        init();
    }

    public XibaResizeImageView(Context context, AttributeSet attrs) {
        super(context, attrs);
        init();
    }
